import { c as createComponent } from './astro-component_Ckzq4_o_.mjs';
import 'piccolore';
import { r as renderTemplate, i as renderSlot, f as addAttribute, j as renderHead, m as maybeRenderHead, k as renderComponent, l as Fragment } from './ssr-function_DpRYvlox.mjs';
...
<span class="grp-note" data-astro-cid-bdsczzry>era-fair dominance · <a href="/methodology" class="grp-link" data-astro-cid-bdsczzry>what is this?</a></span> </th> </tr> ${f1dRows.map((row) => {
  ...
  })}` })}`} <!-- ── WINS & PODIUMS (era-dependent) ─────────────── --> <tr class="grp-hd" data-astro-cid-bdsczzry> <th colspan="3" data-astro-cid-bdsczzry>
Wins &amp; podiums
