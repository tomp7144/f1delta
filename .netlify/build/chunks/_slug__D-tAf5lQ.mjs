...
import 'piccolore';
import { r as renderTemplate, i as renderSlot, f as addAttribute, j as renderHead, m as maybeRenderHead, k as renderComponent, l as Fragment } from './ssr-function_R-TSrMrG.mjs';
...
const $$F1DeltaExplain = createComponent(($$result, $$props, $$slots) => {
  ...
  const { compareNote = false, seasonNote = false } = Astro2.props;
